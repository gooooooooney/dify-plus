const translation = {
  ...
  modelSyncWorkspace: {
    modalName: 'Espacio de trabajo de sincronización de modelo',
    workspaceNamePlaceholder: 'Seleccione un espacio de trabajo',
    workspaceSynced: 'Espacio de trabajo de modelo sincronizado con éxito',
    workspaceSyncFailed: 'Error en la sincronización del espacio de trabajo del modelo',
    isSyncAll: '¿Sincronizar todo?',
