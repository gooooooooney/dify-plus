const translation = {
  ...
  modelSyncWorkspace: {
    modalName: 'พื้นที่ทำงานซิงค์โมเดล',
    workspaceNamePlaceholder: 'กรุณาเลือกพื้นที่ทำงาน',
    workspaceSynced: 'ซิงค์พื้นที่ทำงานโมเดลสำเร็จ',
    workspaceSyncFailed: 'ซิงค์พื้นที่ทำงานโมเดลล้มเหลว',
    isSyncAll: 'ต้องการซิงค์ทั้งหมดหรือไม่',
    syncButton: 'ซิงค์',
  },
