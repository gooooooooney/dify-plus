const translation = {
  ...
  modelSyncWorkspace: {
    modalName: 'Espace de travail de synchronisation de modèle',
    workspaceNamePlaceholder: 'Veuillez sélectionner un espace de travail',
    workspaceSynced: 'Espace de travail de modèle synchronisé avec succès',
    workspaceSyncFailed: 'Échec de synchronisation de l\'espace de travail de modèle',
    isSyncAll: 'Synchroniser tout',
