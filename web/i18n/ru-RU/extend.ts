const translation = {
  ...
  modelSyncWorkspace: {
    modalName: 'Рабочее пространство синхронизации модели',
    workspaceNamePlaceholder: 'Пожалуйста, выберите рабочее пространство',
    workspaceSynced: 'Рабочее пространство синхронизации модели успешно',
    workspaceSyncFailed: 'Не удалось синхронизировать рабочее пространство модели',
    isSyncAll: 'Синхронизировать все',
