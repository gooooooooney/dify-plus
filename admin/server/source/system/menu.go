...
func (i *initMenu) InitializeData(ctx context.Context) (next context.Context, err error) {
	...
	entities := []SysBaseMenu{
		...
		{MenuLevel: 0, Hidden: false, ParentId: 0, Path: "providers", Name: "providers", Component: "view/gaia/providers/providers.vue", Sort: 1, Meta: Meta{Title: "模型管理", Icon: "present"}},
